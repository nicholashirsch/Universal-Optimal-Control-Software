...
%          define and solve a nonlinear programming problem using P-GPOPS.
    ...
    LGRDist   = [10 10 10 10 10 10 10 10 10 10];
    ...
    boundaryInitialMin = [0 1];
    boundaryInitialMax = [0 1];
    
    interiorStateMin   = [-inf -inf];
    interiorStateMax   = [LENGTH inf];
  
    boundaryFinalMin   = [0 -1];
    boundaryFinalMax   = [0 -1];
    ...
    lagrangeCost = @(state, control) 0.5*control.^2;
